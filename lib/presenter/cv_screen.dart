                  ...
                  Row(
                    children: [
                      ...
                      RichText(
                        text: TextSpan(
                          children: <TextSpan>[
                            const TextSpan(text: 'Gabriel ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 50.0, color: Colors.redAccent)),
                            TextSpan(text: 'Augusto de Deus', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 50.0, color: context.theme.primaryColor)),
                            TextSpan(text: '\nDesenvolvedor', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 50.0, color: context.theme.primaryColor)),
                          ],
                        ),
                      ),
                    ],
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/flutter.png', 'Flutter')),
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/dart.png', 'Dart')),
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/javascript--v1.png', 'Javascript')),
                              LineIconHabilty(Hability('https://img.icons8.com/fluency/48/000000/typescript.png', 'Typescript')),
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/react-native.png', 'ReactJS e Native')),
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/html-5--v1.png', 'HTML')),
                              LineIconHabilty(Hability('https://img.icons8.com/dusk/48/000000/css3.png', 'CSS')),
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/java-coffee-cup-logo--v1.png', 'Java')),
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/kotlin.png', 'Kotlin')),
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/android-os.png', 'Android')),
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/firebase.png', 'Firebase')),
                              LineIconHabilty(Hability('https://img.icons8.com/office/48/000000/spring-logo.png', 'Spring boot')),
                              LineIconHabilty(Hability('https://img.icons8.com/color/48/000000/swift.png', 'Swift')),
                              LineIconHabilty(Hability('https://img.icons8.com/ios-filled/50/000000/ios-logo.png', 'iOS')),
                              LineIconHabilty(Hability('https://img.icons8.com/ios-filled/50/000000/ios-logo.png', c.isLightTheme.toString())),
                              Padding(
                                padding: const EdgeInsets.symmetric(vertical: 8.0),
